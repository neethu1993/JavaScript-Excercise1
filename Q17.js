...
//Converting the specified object to the object
for (i in jsonStr.articles) {
    var sub = { 'author': jsonStr.articles[i].author, 'title': jsonStr.articles[i].title, 'description': jsonStr.articles[i].description };
    obj.push(sub);
}
console.log(obj);